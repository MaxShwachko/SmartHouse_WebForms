<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="RenameRoom.aspx.cs" Inherits="SmartHouse_WebForms.RenameRoom" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:textbox id="RoomName" class="form-control text-box single-line" data-val="true" data-val-required="Требуется поле Name." runat="server"></asp:textbox>
